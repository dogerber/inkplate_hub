...
bool Network::getData(char *calendarURL, char *data)
{
    ...
    Serial.println("Prepare HTML request");
    HTTPClient http;
    ...
    // Actually do request
    Serial.println("Download until finished ...");
    ...
    if (httpCode == 200)
    {
        ...
        {
            // Serial.println("Download ongoing ...");
        ...
        Serial.println("Download completed. Check if download complete...");
